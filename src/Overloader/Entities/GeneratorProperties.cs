...
{
	private static readonly Dictionary<ITypeSymbol, FormatterDto> Empty = new(0, SymbolEqualityComparer.Default);

	private readonly Dictionary<ITypeSymbol, FormatterDto> _formatters;
	private readonly Dictionary<ITypeSymbol, FormatterDto> _overloadFormatters;
	...
	public GeneratorProperties(
		...
		Dictionary<ITypeSymbol, FormatterDto>? formatters,
		bool isDefaultOverload,
		string className,
		ITypeSymbol[] templates,
		Dictionary<ITypeSymbol, FormatterDto>? overloadFormatters)
	{
		Context = context;
		Compilation = compilation;
		...
		void VerifyFormatters(Dictionary<ITypeSymbol, FormatterDto> formattersToCheck)
		{
	...
	public bool TryGetFormatter(ITypeSymbol type, out FormatterDto formatter) =>
